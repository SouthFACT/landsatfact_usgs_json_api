...
module.exports = {
  ...
  */
  ...
  update_metadata: function (field_set) {
    ...
    //limit to only fields we want to update - "browse_url, cc_full, data_type_l1, scene_id
    var fields = [field_parameters[0],field_parameters[3],field_parameters[6],field_parameters[11]]

    //update missing data 
    const update_sql = ""
    +"UPDATE landsat_metadata"
      +" SET browse_url = $2::text, cc_full = $3, data_type_l1 = $4::text"
  ...
  insert_metadata: function (field_set) {
    ...
    +"INSERT INTO landsat_metadata("
      +"scene_id, sensor, acquisition_date, browse_url, path, row, cc_full, "
