...
var DownloadScenes = function() {
  ...
  const DOWNLOAD_DIR = process.env.LSF_API_DOWNLOAD_DIR
  const DOWNLOAD_FILE_DIR = process.env.LSF_API_DOWNLOAD_FILE_DIR
  const DOWNLOAD_FILE_LCV_DIR = process.env.LSF_API_DOWNLOAD_FILE_LCV_DIR
