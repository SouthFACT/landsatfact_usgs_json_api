...
const query_text = "SELECT * FROM vw_failed_products" 

//"SELECT " + scenes_fields + " FROM landsat_metadata WHERE landsat_metadata.acquisition_date = ('now'::text::date - '1 days'::interval day) and needs_processing = 'YES' AND  downloaded = 'YES'"
