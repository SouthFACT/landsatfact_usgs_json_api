...
function app_helpers() {
  ...
  return {
    ...
    delete_old_files: function(){
      ...
      var file = 'logs/check_orders_landsat_data-' + week_ago_string+ '.log'
      ...
      file = './downloaded-' + week_ago_string+ '.txt'
      this.delete_file(file)

      file = './ordered -' + week_ago_string+ '.txt'
      this.delete_file(file)
    },
