...
module.exports = {
  ...
  get_usgs_response_code: function(request_code){
    ...
    if (valid_request_codes.indexOf(request_code) >= 0) {
      ...
      return this.throw_error('request ' + request_code + ' is not available or is an invalid request code.  Check the USGS JSON api documentation @ http://earthexplorer.usgs.gov/inventory/documentation.  Maybe the request code is a new call that has been added to the api but not updated here.');;
    }
  },
